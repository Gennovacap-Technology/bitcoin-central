...
ActiveRecord::Schema.define(version: 20140220183952) do
  ...
  add_index "account_operations", ["lr_transaction_id"], name: "index_account_operations_on_lr_transaction_id", unique: true, using: :btree
  ...
  add_index "invoices", ["authentication_token"], name: "index_invoices_on_authentication_token", unique: true, using: :btree
  add_index "invoices", ["payment_address"], name: "index_invoices_on_payment_address", unique: true, using: :btree
  add_index "invoices", ["reference"], name: "index_invoices_on_reference", unique: true, using: :btree
